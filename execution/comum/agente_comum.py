...
class AgenteComum:
    ...
    def set_toolkit(self, toolkit: Toolkit) -> "AgenteComum":
        """Define o toolkit de ferramentas disponíveis para o agente."""
        self._toolkit = toolkit
        return self

    def set_prompt(self, prompt: str) -> "AgenteComum":
        """Define as instruções (system prompt) do agente."""
        self._prompt = prompt
        return self

    def set_output_schema(self, schema: dict) -> "AgenteComum":
        """Define o schema JSON de saída esperado do agente."""
        self._output_schema = schema
        return self

    async def obter_resposta(self, contexto_entrada: list[dict]) -> RespostaAgenteComum:
        """
        ...
        :return: RespostaAgenteComum com content, duracao e tokens.
        """
